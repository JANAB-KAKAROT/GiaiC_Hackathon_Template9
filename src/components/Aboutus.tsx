  ...
  return (
    <section className="bg-black px-4 md:px-[135px] flex flex-col justify-evenly md:flex-row md:items-center py-[50px]">
      ...
      <div className="text-white w-full md:w-[50%]">
        ...
        Il cibo pakistano offre sapori speziati e intensi. Biryanis aromatici, curries ricchi e pane naan fresco. Piatti tradizionali cucinati con passione e spezie uniche. Dolci come il gulab jamun completano un’esperienza culinaria unica.
        </p>
